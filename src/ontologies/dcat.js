...
var _this = __importStar(require("./dcat.js"));
var dataFile = '../data/dcat.json';
/**
...
var loadData = function () {
    if (typeof module !== 'undefined' && typeof exports !== 'undefined') {
        // CommonJS import
        return Promise.resolve().then(function () { return __importStar(require('../data/dcat.json')); });
    }
    else {
        // ESM import
        //@ts-ignore
        return Promise.resolve().then(function () { return __importStar(require('../data/dcat.json')); }).then(function (data) { return data.default; });
    }
};
